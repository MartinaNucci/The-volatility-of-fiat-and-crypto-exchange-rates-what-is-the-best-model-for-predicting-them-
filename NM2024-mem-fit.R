...
#source("~/Cipo/Teaching/Thesis/NucciMartina-2024/R/BA2023-mem-Functions.R")
...
#file.out<-"C:\\Users\\marti\\OneDrive\\Desktop\\tesi\\output\\cripto_mem(1,1)_fit.txt"
#file.out<-"C:\\Users\\marti\\OneDrive\\Desktop\\tesi\\output\\cripto_mem(2,1)_fit.txt"

file.out<-"C:\\Users\\marti\\OneDrive\\Desktop\\tesi\\output\\tassi_std_mem(1,1)_fit.txt"
#file.out<-"C:\\Users\\marti\\OneDrive\\Desktop\\tesi\\output\\tassi_std_mem(2,1)_fit.txt"
...
symbols <- c(
  ...
  'USD_AUD','USD_CAD','USD_EUR','USD_GBP','USD_JPY','USD_RUB','USD_BRL','USD_CHF','USD_KRW','USD_TRY','USD_TWD','USD_INR') # standard exchange-rate directory
...
symbols.dates <- data.frame(symbol = rep(symbols, each = NROW(rolling.dates)), 
  rolling.dates)
# joins each currency to the rolling-window table
