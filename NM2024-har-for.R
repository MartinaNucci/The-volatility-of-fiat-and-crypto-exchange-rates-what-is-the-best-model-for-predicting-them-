################################################################################
##
## File:    BA2023-har-flt.R
##
## Purpose: HAR forecasting.
##  
## Created: 2021.12.05
##
## Version: 2023.09.15
...
#file.fit<-"C:\\Users\\marti\\OneDrive\\Desktop\\tesi\\output\\cripto_har_fit.txt"
file.fit <- "C:\\Users\\marti\\OneDrive\\Desktop\\tesi\\output\\tassi_std_har_fit.txt"

period.out <- "12 months" # period used for ex-post analysis

#file.out<-"C:\\Users\\marti\\OneDrive\\Desktop\\tesi\\output\\cripto_har_for.xlsx" 
file.out<-"C:\\Users\\marti\\OneDrive\\Desktop\\tesi\\output\\tassi_std_har_for.xlsx"
...
#### Symbols and Dates
symbols.dates <- .har.fit.symbols.dates(file = file.fit, period.out = period.out)
...
for (i in 1 : nsd)
{
  ...
  fit <- .har.fit.read(file = file.fit, symbol = symbol, 
    dates = date.range)
