...
#file.out<-"C:\\Users\\marti\\OneDrive\\Desktop\\tesi\\output\\cripto_naive_fit.txt"
file.out<-"C:\\Users\\marti\\OneDrive\\Desktop\\tesi\\output\\tassi_std_naive_fit.txt"
...
for (i in 1 : nsd)
{
  #### Extract # reads the currency from row i
  ...
  #### Fit
  fit <- .naive.fit(data = data)
  #### Inference
  inf <- .naive.inference(fit = fit) 
  #### File
